...
select * from meslekler limit 5 offset 2

-- SORU8: meslekler tablosunda en yüksek maaşı alan 4. 5. 6. kişilerin bilgilerini listele

select * from meslekler order by maas limit 3 offset 3
...
select actor_name, film_name from aktorler as A left join filmler as B
on A.id=B.film_id


--2.Yol Right Join

select actor_name, film_name from filmler as A right join aktorler as B
on A.film_id=B.id
...
--SORU4: join kullanarak qa_dersleri ve developer_dersleri benzersiz sorgul
