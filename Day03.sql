...
INSERT INTO ogrenciler1 VALUES(127, 'Mustafa Bak', 'Ali', 99);
select * from ogrenciler1
-- İsmi Mustafa Bak ve Nesibe Yılmaz olan kayıtları silelim
DELETE FROM ogrenciler1 WHERE isim='Mustafa Bak' or isim = 'Nesibe Yilmaz';
-- Veli ismi Hasan datayi silelim
DELETE FROM ogrenciler1 WHERE veli_isim='Hasan';
-- TRUNCATE -- 
-- Bir tablodaki tüm verileri geri alamayacağımız şekilde siler. Şartlı silme yapmaz
TRUNCATE ogrenciler1
-- ON DELETE CASCADE 
...
*/
SELECT marka_id,calisan_sayisi FROM markalar WHERE marka_isim IN (SELECT isyeri FROM calisanlar2 WHERE sehir In('Ankara'))
